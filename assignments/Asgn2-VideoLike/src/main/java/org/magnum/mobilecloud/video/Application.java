...
public class Application extends OAuth2SecurityConfiguration /*RepositoryRestMvcConfiguration*/ {
	...
	//
	/**
	 * 	You will also need to remove one of the containerCustomizer() methods in either
	 * OAuth2SecurityConfiguration or Application (they are the exact same code).
	 */
	/*
    @Bean
